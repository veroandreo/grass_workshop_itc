...
We will use GRASS GIS 7.2 (current stable version). It can be installed either through standalone installers/binaries or get it through OSGeo-Live (which includes all OSGeo software and packages).
